          ...
          <div className="form-group col-md-8">
            ...
            {addUpdateFlag ? (
              <button
                ...
                style={{ width: "150px", float: "left", marginRight: 50, marginLeft : 285 }}
                onClick={addProduct}
              >
                Add
              </button>
                ...
                <div >
                  <button
                    className="btn btn-primary"
                    style={{ width: "150px", float: "left", marginLeft : 105 , marginRight : 40}}
                  ...
                  <button
                    className="btn btn-primary"
                    style={{ width: "150px", float: "left", marginBottom: 20, marginRight: 40 }}
                    onClick={Cancel}
                  >
                    Cancel
                  </button>
            ...
            {product.map((val, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>
                    <button
                      onClick={(e) => editItem(e, val.productId)}
                    >
                      Edit
                    </button>{" "}
                  </td>
                  <td>
                    <button
                      onClick={(e) => deleteItem(e, val.productId)}
                    >
                      Delete
                    </button>{" "}
                  </td>
